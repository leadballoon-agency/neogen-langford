...
export default function VideoModal({ isOpen, onClose }: VideoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      {/* Video Container - Landscape orientation for YouTube */}
      <div className="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:aspect-video bg-black sm:rounded-3xl shadow-2xl overflow-hidden animate-modal-slide-up">
        ...
        <div className="relative w-full h-full bg-black flex items-center justify-center">
          <iframe
            className="w-full h-full sm:aspect-video"
            src="https://www.youtube.com/embed/yFb6b2Q2q_E?autoplay=1&rel=0"
            title="Shirley Ballas Neogen Treatment at The Langford Skin Clinic"
