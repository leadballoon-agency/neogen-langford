    ...
    <section className="py-12 sm:py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto section-padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {reviews.map((review, index) => (
            <div key={index} className="bg-white border-2 border-neutral-100 rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 hover:border-primary-200 hover:shadow-lg transition-all duration-300">
              {/* Rating Stars */}
              <div className="flex items-center space-x-0.5 mb-3 sm:mb-4">
                {[...Array(5)].map((_, i) => (
              ...
              {/* Review Text */}
              <p className="text-neutral-700 text-[13px] sm:text-sm lg:text-base mb-3 sm:mb-4 leading-relaxed">
                "{review.text}"
              </p>

              {/* Treatment Badge */}
              <div className="inline-block bg-primary-50 text-primary-700 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full text-[11px] sm:text-xs font-medium mb-3 sm:mb-4">
                {review.treatment}
              </div>
              ...
              <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-neutral-100">
                ...
                {review.verified && (
                  <div className="flex items-center text-green-600 text-[11px] sm:text-xs">
        ...
        <div className="mt-10 sm:mt-16 text-center">
          <div className="inline-flex items-center space-x-3 sm:space-x-4 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
            <svg className="w-10 h-10 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex-shrink-0" viewBox="0 0 48 48">
            ...
            <div className="text-left">
              <p className="font-semibold text-neutral-900 text-sm sm:text-base lg:text-lg mb-1">Read more reviews on Google</p>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs sm:text-sm text-neutral-600">5.0 rating</span>
              </div>
            </div>
          </div>
        </div>
